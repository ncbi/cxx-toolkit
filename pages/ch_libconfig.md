...
| Do not release server throttling until the server appears in LBSMD                                                                                                                                                                                                | **`[PSG]`**<br/>**`throttle_hold_until_active_in_lb`**<br/><br/>N/A                                                                                                                                  | Boolean [<sup>c</sup>](#ch_libconfig.TF.psg_client_library.3)             | false                      |
