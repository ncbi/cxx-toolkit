...
| Maximum number of concurrent streams per session (TCP connection)                                                                                                                                                      | **`[PSG]`**<br/>**`max_concurrent_streams`**<br/><br/>**`NCBI_CONFIG__PSG__MAX_CONCURRENT_STREAMS`**[<sup>a</sup>](#ch_libconfig.TF.13.1.1) | integer                                                     | 200                        |
