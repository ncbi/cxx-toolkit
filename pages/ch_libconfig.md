...
| Specifies whether to print X-JA3-SIG header value during [LogRequest()](https://www.ncbi.nlm.nih.gov/IEB/ToolBox/CPP_DOC/lxr/ident?i=LogRequest). | **`[CGI]`**<br/>**`Print_JA3_SIG`**<br/><br/>**`CGI_PRINT_JA3_SIG`**  | Boolean  [<sup>c</sup>](#ch_libconfig.TF.25)         | true     |
