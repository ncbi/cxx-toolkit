...
| Use `poll(2)` instead of `select(2)` to wait for available data for reading/writing.  This is necessary if the number of open file descriptors exceeds 1024.<br/>(See [Note 1](#ch_libconfig.TF.21)) | **`[<service>]`**<br/>**`CONN_PIPE_USE_POLL`**<br/><br/>**`<service>_CONN_PIPE_USE_POLL`** | Boolean  [<sup>c</sup>](#ch_libconfig.TF.17) | false |
