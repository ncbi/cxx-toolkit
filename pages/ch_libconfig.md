...
| Maximum number of concurrent requests per server.                                                                                                                                                                      | **`[PSG]`**<br/>**`max_concurrent_requests_per_server`**<br/><br/>**`NCBI_CONFIG__PSG__MAX_CONCURRENT_REQUESTS_PER_SERVER`**[<sup>a</sup>](#ch_libconfig.TF.13.1.1) | integer                             | 500                        |
