...
| Specifies whether to print X-JA*-SIG header values during [LogRequest()](https://www.ncbi.nlm.nih.gov/IEB/ToolBox/CPP_DOC/lxr/ident?i=LogRequest). Overrides the legacy Print_JA3_SIG flag. | **`[CGI]`**<br/>**`Print_JA_SIG`**<br/><br/>**`CGI_PRINT_JA_SIG`**  | Boolean  [<sup>c</sup>](#ch_libconfig.TF.25)         | true     |
