...
| If true, use memory-mapped file access, which associates a file’s content with a portion of the virtual address space of a process. This can result it modest performance increase (probably &lt; 15%). | **`[SERIAL]`**<br/>**`READ_MMAPBYTESOURCE`**<br/><br/>**`SERIAL_READ_MMAPBYTESOURCE`** | Boolean  [<sup>c</sup>](#ch_libconfig.TF.35) | false |
