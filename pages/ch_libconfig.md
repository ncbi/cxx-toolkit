...
| Number of internal I/O threads. Each thread has one TCP connection per server in service                                                                                                                               | **`[PSG]`**<br/>**`num_io`**<br/><br/>**`NCBI_CONFIG__PSG__NUM_IO`**[<sup>a</sup>](#ch_libconfig.TF.13.1.1)                                 | integer                                                     | 6                          |
