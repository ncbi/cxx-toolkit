...
| Sets/overrides a cookie value for any authorization token (from the 'auth_token' property of the request context).                                                                                                                                                | **`[PSG]`**<br/>**`auth_token`**<br/><br/>**`NCBI_PSG_AUTH_TOKEN`**                                                                                                                                  | string                                                                    | ""                         |
