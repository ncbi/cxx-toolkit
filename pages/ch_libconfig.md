...
| Sets the DTAB (delegation table) for routing via NAMERD.<br/>(See [Note 1](#ch_libconfig.TF.21)) | **`[<service>]`**<br/>**`CONN_DTAB`**<br/><br/>**`<service>_CONN_DTAB`** | [string](http://mini.ncbi.nlm.nih.gov/1qcp0) | "" |
